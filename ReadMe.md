...
classDiagram 
    ...
    class Board {
        ...
        +Board(Vector2f pos,SDL_Texture* texture,int frameWidth,int frameHeight, RenderWindow& window, SDL_Texture* p_tileset, SDL_Texture* SELECTED_FILE,SDL_Texture* MOVE_FILE,SDL_Texture* ATTACK_FILE)
